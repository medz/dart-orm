...
| §12 declaration table: general CHECK constraints | Declaration, emitted constraint, native enforcement and NULL semantics, introspection/import, drift and reviewed add/change/remove/rename migrations. Integer-width/decimal checks and preservation of unmanaged checks are narrower evidence. |
