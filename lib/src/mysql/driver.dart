...
/// Owns one MariaDB connection and serializes complete connection leases.
///
/// The server must identify itself as MariaDB 10.6 or newer. MySQL servers are
/// rejected even when their protocol is compatible.
final class MariadbDriver extends _MysqlDriver<Mariadb> {
  ...
  /// Opens MariaDB and configures UTC and strict SQL behavior.
