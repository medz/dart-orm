/// Project-owned migration command entrypoint with statically imported history.
library;
...
/// Runs a project's statically compiled migration history. Offline commands never
/// call [connect]. The connection factory must honor read-only storage requests.
