...
| Filter groups, text and comparison types | `predicate_groups`, `predicate_groups_database`, `predicate_groups_types`, `text_expression`, `text_expression_types`, and their `mysql_*` database entrypoints |
